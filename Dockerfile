...
LABEL org.opencontainers.image.source https://github.com/mehdiattar-lab/CIS.git
LABEL org.opencontainers.image.description "Docker image for the customer information system (CIS) component."
